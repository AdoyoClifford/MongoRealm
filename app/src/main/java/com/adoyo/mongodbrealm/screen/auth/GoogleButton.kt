package com.adoyo.mongodbrealm.screen.auth
...
import androidx.compose.ui.unit.dp
import com.adoyo.mongodbrealm.R
...
fun GoogleButton(
    ...
    Surface(
        ...
        shape = shape,
        border = BorderStroke(width = borderStrokeWidth, color = borderColor), color = background
    ) {
        Row(
            modifier = Modifier
                .fillMaxWidth()
